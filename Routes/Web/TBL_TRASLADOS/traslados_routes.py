...
from Database.Database import db, TBL_TRASLADOS
...
def create_traslado():
    ...
    new_traslado = TBL_TRASLADOS(nombre_traslado=nombre_traslado)
...
def get_all_traslados():
    traslados = TBL_TRASLADOS.query.all()
...
def get_traslado(id):
    traslado = TBL_TRASLADOS.query.get(id)
    if not traslado:
